...
(function (global) {
  ...
  var STRINGS = {
    fr: {
      ...
      'record.vuln': 'La plus grande fragilité reste le « front républicain » : le report des voix vers un finaliste RN est estimé sur 2022, et rien ne garantit qu’il se comporte pareil en 2027. C’est l’hypothèse qui peut déplacer le chiffre principal de dix points.',
    ...
    en: {
      ...
      'record.vuln': 'The biggest fragility remains the front républicain — how readily votes transfer to an RN finalist is estimated from 2022, and nothing guarantees 2027 behaves the same. It is the assumption that can move the headline by ten points.',
